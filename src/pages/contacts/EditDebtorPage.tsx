...
export function EditDebtorPage() {
  ...
  const fetchDebtor = async () => {
    ...
    try {
      ...
      alert('Failed to load debtor information. Please try again.');
      navigate('/contacts/debtors');
    } finally {
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end space-x-4">
            <button
              type="button"
              onClick={() => navigate(`/contacts/debtors/${id}`)}
